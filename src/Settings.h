...
{
    return _parameters.at("acceptrateOutfile").value<std::string>();
}


inline std::string Settings::getLambdaNodeOutfile() const
{
    return _parameters.at("lambdaNodeOutfile").value<std::string>();
}
...
{
    return _parameters.at("nodeStateOutfile").value<std::string>();
}
